          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
               ...
               <a   class="btn btn-primary" href="/gallery">  Gallery List     </a>

               <br/>
               <br/>
               <br/>
                <form  method="post" action="@if(isset($slidder)) /gallery/{{ $slidder->id }}  @else /gallery @endif"  enctype="multipart/form-data"   >
                  ...
                  <div class="form-group">
                   ...
                   <div   id="preview" @if(isset($slidder)) style="background-image: url({{ $slidder->image }}); height: 200px"  @endif >       </div>
                      ...
                      <div class="form-group">
                    <label>Title</label>
                    <input required  name="text1" class="form-control"     placeholder=Title"  value="@if(isset($slidder)) {{ $slidder->text1  }}  @endif"  />
                   ...
                   <input  id="pre_input"     type="hidden"   name="image"    />
                    ...
                    <label  class="btn btn-primary"  for="file-input">Upload  Gallery Image</label>
