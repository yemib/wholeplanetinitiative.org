...
function formatDoc(sCmd, sValue) {
  document.execCommand(sCmd, false, sValue); oDoc.focus(); 
						...
						<div   class="tool_container"   style="display:none; z-index: 6000000000000;position: relative; background: #FFFFFF">			
<div id="toolBar1">
...
<option value="li">List &lt;li&gt;</option>
...
<option>FjallaOne</option>
<option>Anton</option>
<option>Cinzel-Regular</option>
<option>Domine-Regular</option>
<option>EncodeSansSemiCondensed-Regular</option>
<option>FiraSans-Regular</option>
<option>IrishGrover-Regular</option>
<option>JosefinSlab-Regular</option>
<option>Lancelot-Regular</option>
<option>LateefRegOT</option>
<option>OldStandard-Regular</option>
<option>Lobster-Regular</option>
<option>Oswald-Regular</option>
<option>PathwayGothicOne-Regular</option>
<option>Playball-Regular</option>
<option>PT_Sans-Narrow-Web-Regular</option>
<option>Rancho-Regular</option>
<option>Sancreek-Regular</option>
<option>Smythe-Regular</option>
<option>Sunshiney-Regular</option>
<option>SpectralSC-Regular</option>
<option>Teko-Regular</option>
<option>Tillana-Regular</option>
</select>
...
Background :<input   type="color"  value=""   onChange="formatDoc('backcolor',this.value);"  />

Color:
<input   type="color"  value=""   onChange="formatDoc('forecolor',this.value);"  />
...
<div id="toolBar2">
<img class="intLink" title="Clean" onclick="if(confirm('Are you sure?')){document.getElementById('editcontent').innerHTML=''};" src="data:image/gif;base64," />
...
<img class="intLink" title="Paste" onclick="formatDoc('paste');" src="data:image/gif;base64," />
	...
	<label style="z-index: 20000000000000000000"    for="file-article"  class="btn btn-primary">  Add File (Video,Image e.t.c)   </label>
	
		
	
</div> 
<div    class="content_tool"  style=""> 
 </div>
 </div>
